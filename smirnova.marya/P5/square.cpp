...
namespace smirnova
{
  Square::Square(double side, const point_t &center) : side_(side), center_(center)
  {
    if (side <= 0.0)
  ...
  rectangle_t Square::getFrameRect() const noexcept { return makeFrameRect(side_, side_, center_); }
